  ...
  return (
    <div className={`w-full flex flex-col gap-1.5 ${className}`}>
      ...
      <input
        ...
        min={minDate}
        max={maxDate}
        className={`w-full px-4 py-2.5 rounded-xl border bg-white/50 dark:bg-slate-900/50 text-slate-800 dark:text-slate-100 transition-all duration-200 outline-none text-sm ${
          error
